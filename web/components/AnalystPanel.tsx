      ...
      >
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded border border-white/10 bg-black/40 px-2.5 py-1.5 text-[12px] text-zinc-200 outline-none placeholder:text-zinc-600 focus:border-duck/60"
          />
          <button
            type="submit"
